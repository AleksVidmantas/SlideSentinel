...
Make sure you have a version of python and pip. First type sudo apt update, then sudo apt install python-pip. If no version of python was displayed, type sudo apt-get install python. Then pip install geopy. 
